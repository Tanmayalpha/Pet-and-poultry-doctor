...
final Uri getDoctorDegree = Uri.parse(baseUrl + 'get_doctor_degree');
...
final Uri getSubCategoriesApi = Uri.parse(baseUrl + 'get_subcategories');
...
const String ReceiverId = "receiver_id";
const String MessageTitle = "title";
const String Body = "body";
const String Type = "type";
const String FuId = "fuid";
const String Id = 'id';
const String Diagnosis = 'diagnosis';
const String Medicine = 'medicines';
...
final String BankCOde = "ifsc_code";
...
const String IdCard = 'id_card_file';
const String DegreeFile = 'degree_file';
const String Certificate = 'certificate_file';
const String accountNumber = 'account_number';
const String accountName = 'account_holder_name';
const String bankCode = 'ifsc_code';
const String bankName = 'bank_name';
const String Cheque = 'cancel_cheque';
const String taxNumber = 'tax_number';
const String panNumber = 'pan_number';
const String Signature = "signature";
const String DegreeName = "degree_name";
const String UserType = "doc_type";
const String RegistrationNo = "registeration_card_file";
String LIMIT = "limit";
...
final Uri getDoctorSpecialization = Uri.parse(doctorBaseUrl + 'settings');
final Uri getDoctorRegistration = Uri.parse(doctorBaseUrl + 'signup');
final Uri getDoctorLogin = Uri.parse(doctorBaseUrl + 'login');
final Uri getDoctorProfile = Uri.parse(doctorBaseUrl + 'get_user_profile');
final Uri getDoctorUpdateProfile = Uri.parse(doctorBaseUrl + 'update_profile');
final Uri getDoctorUpdatePrivacyPolicy = Uri.parse(doctorBaseUrl + 'page/doctor-privacy-policy');
final Uri getDoctorUpdateTermCondition = Uri.parse(doctorBaseUrl + 'page/doctor-terms-conditions');
final Uri getPatientRequests = Uri.parse(doctorBaseUrl + 'get_requests');
final Uri getDiagnosedRequests = Uri.parse(doctorBaseUrl + 'diagnosed_requests');
final Uri getAcceptRejectRequests = Uri.parse(doctorBaseUrl + 'accept_reject_requests');
final Uri getProductsRequest = Uri.parse(doctorBaseUrl + 'get_products');
final Uri submitDiagnosisRequest = Uri.parse(doctorBaseUrl + 'add_diagnosis');
final Uri getTransactionHistory = Uri.parse(doctorBaseUrl + 'transactions');
final Uri sendWithdrawalRequest = Uri.parse(doctorBaseUrl + 'withdrawl_requests');
final Uri updateFuIdRequest = Uri.parse(doctorBaseUrl + 'update_fuid');
final Uri getDoctorDiagnosedRequest = Uri.parse(doctorBaseUrl + 'get_diagnosed_requests');
final Uri sendNotificationRequest = Uri.parse(doctorBaseUrl + 'send_notification');
final Uri getProductListRequest = Uri.parse(doctorBaseUrl + 'get_products');