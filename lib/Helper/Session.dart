...
Future<void> saveUserDetail(
  ...
  waitList.add(prefs.setString(IdCard, storename));
  waitList.add(prefs.setString(DegreeFile, storeurl));
  waitList.add(prefs.setString(Certificate, storeDesc));
  ...
  waitList.add(prefs.setString(Cheque, cheque));
